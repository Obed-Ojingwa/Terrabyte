...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#03091A] flex items-center justify-center px-6 py-16">
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-white/[0.02] border border-white/[0.07] rounded-3xl p-8">
          ...
          <p className="text-center text-xs text-white/25 mt-5">By registering you agree to our <Link href="#" className="text-brand-400 hover:underline">Terms of Service</Link></p>
        </div>
        <p className="text-center text-sm text-white/35 mt-6">Already have an account? <Link href="/auth/login" className="text-brand-400 font-semibold hover:text-brand-300 transition-colors">Sign in</Link></p>
      </div>
    </div>
  );
}
